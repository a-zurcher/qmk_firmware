...
[_LOWER] = LAYOUT_preonic_grid(
  LSFT(KC_GRV), _______, _______, _______, _______, _______, _______, _______, _______, LSFT(KC_MINS), LSFT(KC_EQL), LSFT(KC_BSPC),
  ...
  KC_LSFT,      KC_NUBS, _______, _______, _______, _______, _______, _______, _______, _______,    _______,    _______,
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTZ,  COLEMAK, DVORAK,  _______, _______,
