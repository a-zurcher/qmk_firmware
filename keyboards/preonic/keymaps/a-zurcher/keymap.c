...
[_QWERTZ] = LAYOUT_preonic_grid(
  ...
  LGUI(KC_F12), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    _______, KC_RSFT,
...
[_LOWER] = LAYOUT_preonic_grid(
  LSFT(KC_GRV), _______, _______,       _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  _______,
